...
--
-- Host: localhost
-- Erstellungszeit: 12. Aug 2016 um 18:54
...
CREATE TABLE IF NOT EXISTS `CREATURE_TYPES` (
  ...
  `MONSTER_TYPE1` int(2) NOT NULL,
  `MONSTER_TYPE2` int(2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `MONSTER_TYPES` (
  `MONSTER_TYPE_ID` int(20) NOT NULL,
...
ALTER TABLE `CREATURE_TYPES`
  ADD KEY `TYPE_ID` (`TYPE_ID`),
  ADD KEY `MONSTER_TYPE1` (`MONSTER_TYPE1`),
  ADD KEY `MONSTER_TYPE2` (`MONSTER_TYPE2`);
...
--
-- Constraints der Tabelle `CREATURE_TYPES`
--
ALTER TABLE `CREATURE_TYPES`
  ADD CONSTRAINT `CREATURE_TYPES_ibfk_2` FOREIGN KEY (`MONSTER_TYPE2`) REFERENCES `MONSTER_TYPES` (`MONSTER_TYPE_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `CREATURE_TYPES_ibfk_1` FOREIGN KEY (`MONSTER_TYPE1`) REFERENCES `MONSTER_TYPES` (`MONSTER_TYPE_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
